        ...
        <>
            ...
            <Container>
                <div className='invoice mt-5 text-center'>
                            ...
                            <table className="table table-bordered align-middle w-75">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>{customerInfo.customerDetails?.name}</td>
                                    </tr>
                                    <tr>
                                        <td>shubham@gmail.com</td>
                                        <td>{customerInfo.customerDetails?.email}</td>
                                    </tr>
                                    <tr>
                                        <td>Sector 63, Noida, India</td>
                                        <td>
                                            {customerInfo.customerDetails?.line1}, {customerInfo.customerDetails?.line2}, <br />
                                            {customerInfo.customerDetails?.city}, {customerInfo.customerDetails?.state}, {customerInfo.customerDetails?.country},
                                            {customerInfo.customerDetails?.postal_code}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>+919090909090</td>
                                        <td>{customerInfo.customerDetails?.phone}</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                    ...
                    <div className='d-flex justify-content-center '>
                        <button className='btn btn-info mb-3' onClick={invoiceDownload}>
